...
impl Robot {
    pub async fn qual(&mut self) {
        ...
        linear
            .drive_distance(dt, Length::new::<inch>(45.0), false, Duration::from_millis(1000))
            .await;

        linear
            .drive_distance(dt, Length::new::<inch>(-20.0), false, Duration::from_millis(1000))
            .await;
    ...
    pub async fn elims(&mut self){
        ...
        linear
            .drive_distance(dt, Length::new::<inch>(17.0), false, Duration::from_millis(525))
            .await;
        swing
            .swing_to(dt, Angle::new::<degree>(-90.0), Length::new::<inch>(-5.0), Duration::from_millis(725))
            .await;
        linear
            .drive_distance(dt, Length::new::<inch>(4.0), false, Duration::from_millis(400))
            .await;
        ...
        turn
            ...
            .await;
        linear
            .drive_distance(dt, Length::new::<inch>(12.0), false, Duration::from_millis(525))
            .await;
        ...
        swing
            .swing_to(dt, Angle::ZERO, Length::new::<inch>(7.0), Duration::from_millis(550))
            .await;
        linear.drive_distance(dt, Length::new::<inch>(-5.0), false, Duration::from_millis(550)).await;
        turn
            .turn_to(dt, Angle::new::<degree>(87.0), Duration::from_millis(850))
            .await;
        linear
            .drive_distance(dt, Length::new::<inch>(25.0), false, Duration::from_millis(700))
            .await;
    ...
    pub async fn safequals(&mut self){
        ...
        let time = Instant::now();
        linear.drive_distance(dt, Length::new::<inch>(33.0), false, Duration::from_millis(1000)).await;
        turn.turn_to(dt, Angle::new::<degree>(135.0), Duration::from_millis(750)).await;
        self.intake.set_voltage(-Motor::V5_MAX_VOLTAGE);
        linear.drive_distance(dt, Length::new::<inch>(4.0), false, Duration::from_millis(850)).await;
        linear.drive_distance(dt, Length::new::<inch>(-49.0),false,Duration::from_millis(1500)).await;
        turn.turn_to(dt, Angle::new::<degree>(-90.0), Duration::from_millis(850)).await;
        self.intake.set_voltage(0.0);
        linear.drive_distance(dt, Length::new::<inch>(8.0),false, Duration::from_millis(850)).await;
        sleep(Duration::from_millis(2500)).await;
        linear
            .drive_distance(dt, Length::new::<inch>(-12.0), false, Duration::from_millis(570))
            .await;
        turn
            .turn_to(dt, Angle::new::<degree>(85.0), Duration::from_millis(625))
            .await;
        linear
        ...
        linear.drive_distance(dt, Length::new::<inch>(-5.0),false, Duration::from_millis(550)).await;
        turn
            .turn_to(dt, Angle::new::<degree>(85.0), Duration::from_millis(850))
            .await;
        linear
            .drive_distance(dt, Length::new::<inch>(28.0), false, Duration::from_millis(700))
            .await;
